...
DEF_HELPER_0(memfence, void)
DEF_HELPER_0(pause, void)
DEF_HELPER_0(barrier, void)
DEF_HELPER_3(cmpxchg_b, i64, tl, i64, i64) 
DEF_HELPER_3(cmpxchg_w, i64, tl, i64, i64) 
DEF_HELPER_3(cmpxchg_l, i32, tl, i32, i32) 
DEF_HELPER_3(cmpxchg_q, i64, tl, i64, i64) 
DEF_HELPER_2(xchg_b, i64, tl, i64)
DEF_HELPER_2(xchg_w, i64, tl, i64)
DEF_HELPER_2(xchg_l, i32, tl, i32)
DEF_HELPER_2(xchg_q, i64, tl, i64)
DEF_HELPER_2(xadd_b, i64, tl, i64)
DEF_HELPER_2(xadd_w, i64, tl, i64)
DEF_HELPER_2(xadd_l, i32, tl, i32)
DEF_HELPER_2(xadd_q, i64, tl, i64)
DEF_HELPER_2(add_b, i64, tl, i64)
DEF_HELPER_2(add_w, i64, tl, i64)
DEF_HELPER_2(add_l, i32, tl, i32)
DEF_HELPER_2(add_q, i64, tl, i64)
DEF_HELPER_2(sub_b, i64, tl, i64)
DEF_HELPER_2(sub_w, i64, tl, i64)
DEF_HELPER_2(sub_l, i32, tl, i32)
DEF_HELPER_2(sub_q, i64, tl, i64)
...
#ifdef TARGET_X86_64
DEF_HELPER_3(print_test, void, tl, tl, tl) 
